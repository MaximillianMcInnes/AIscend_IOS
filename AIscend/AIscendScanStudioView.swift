                    ...
                    VStack(alignment: .leading, spacing: AIscendTheme.Spacing.xLarge) {
                        heroCard {
                            withAnimation(AIscendTheme.Motion.reveal) {
                                proxy.scrollTo("capture-protocol", anchor: .top)
                            }
                        } onOpenLatestResult: {
                            onOpenLatestResult()
                        }
            ...
            VStack(alignment: .leading, spacing: AIscendTheme.Spacing.large) {
                ...
                HStack(spacing: AIscendTheme.Spacing.small) {
                    ...
                    Button(action: onPrepare) {
                        AIscendButtonLabel(title: "Prepare Capture", leadingSymbol: "camera.metering.center.weighted")
                    }
                    .buttonStyle(AIscendButtonStyle(variant: .secondary))
                }

                Text("Fresh scan results open automatically after capture, and the latest reveal can be revisited here anytime.")
