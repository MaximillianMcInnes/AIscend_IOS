...
private struct AIscendChatScreen: View {
        ...
        GeometryReader { geometry in
            ZStack {
                ...
                VStack(spacing: 0) {
                    ...
                    messageScroller(bottomInset: composerReservedHeight(for: geometry))
                }
            ...
            .safeAreaInset(edge: .bottom, spacing: 0) {
                composer
                    ...
                    .padding(.top, AIscendTheme.Spacing.small)
                    .padding(.bottom, max(geometry.safeAreaInsets.bottom, 10) + tabBarClearance)
                    .background(
                        LinearGradient(
                            colors: [
                                AIscendTheme.Colors.appBackground.opacity(0),
                                AIscendTheme.Colors.appBackground.opacity(0.72),
    ...
    private func composerReservedHeight(for geometry: GeometryProxy) -> CGFloat {
        170 + max(geometry.safeAreaInsets.bottom, 10) + tabBarClearance
    }
    ...
    private var ambientDecor: some View {
        ZStack {
            RadialGradient(
                colors: [
                    AIscendTheme.Colors.accentGlow.opacity(0.14),
                    .clear
                ],
                center: .topTrailing,
                startRadius: 0,
    ...
    private func messageScroller(bottomInset: CGFloat) -> some View {
