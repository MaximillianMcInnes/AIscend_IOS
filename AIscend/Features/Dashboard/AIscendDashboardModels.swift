...
struct DashboardSnapshot {
    ...
    @MainActor static func live(from model: AppModel, now: Date = .now) -> DashboardSnapshot {
...
private extension DashboardSnapshot {
    @MainActor static func derivedScore(from model: AppModel, goals: [AnalysisGoal]) -> Int {
    ...
    @MainActor static func headerLine(from model: AppModel, primaryGoal: AnalysisGoal) -> String {
    ...
    @MainActor static func heroLine(from model: AppModel, primaryGoal: AnalysisGoal) -> String {
    ...
    @MainActor static func routineInsight(for model: AppModel) -> DashboardInsightModel {
        let detail: String
